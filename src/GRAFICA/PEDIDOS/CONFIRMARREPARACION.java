...
public class CONFIRMARREPARACION extends javax.swing.JInternalFrame {
    private int x;
    private int y;
    ...
    public CONFIRMARREPARACION(ArrayList<PEDIDO> lista) {
        this.lista=lista;
        initComponents();
    ...
    public void llenarTabla(){
        borrarTabla();
        for (PEDIDO com : lista) {//"Componente", "Modelo", "Color", "Tapiz","Falla"});
            dftm.addRow(new Object[]{com.getCantidad(),com.getComponente(),com.getModelo(),com.getColor(),
                com.getTapizado(),""
            });
            txtFolio.setText(com.getFolio());
            txtCliente.setText(com.getCliente());
            txtFechaDev.setText(fSalida.format(com.getFechaCreacion()) );
            txtFechaEnvio.setText(fSalida.format(com.getFechaEntrega()));
        }
    }
    public void recojerLista(){
        for(int i=0;i<jTable1.getRowCount();i++){
            lista.get(i).setObservaciones_pedido(jTable1.getValueAt(i, 5).toString());
        }
    }
    ...
    public void crearTabla(){
        ...
        dftm.setColumnIdentifiers(new Object[]{"cant","Componente", "Modelo", "Color", "Tapiz","Notas"});
    }
    ...
    private void initComponents() {
        ...
        txtFechaDev = new javax.swing.JLabel();
        txtFechaEnvio = new javax.swing.JLabel();
        ...
        jLabel2.setText("CONFIRMAR SOLICITUD DE REPARACION");
        ...
        jLabel6.setText("Nueva fecha de envio");

        txtFechaDev.setText("jLabel7");

        txtFechaEnvio.setText("jLabel8");

        txtFolio.setText("jLabel3");

        txtCliente.setText("jLabel7");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 341, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtFechaDev, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void imgCerrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imgCerrarMouseClicked
        ...
        recojerLista();
         if(modPedidos.guardarReparaciones(lista)){
           REPARACION.cerrar();
            this.dispose();
        }else{
    ...
    private javax.swing.JLabel txtFechaDev;
    private javax.swing.JLabel txtFechaEnvio;
