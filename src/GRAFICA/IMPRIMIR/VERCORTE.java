...
public class VERCORTE extends javax.swing.JInternalFrame {
    private int x;
    private int y;
    ...
    public void llenarTabla(){
        borrarTabla();
        lista=modMuebles.obtenerRutasCorte(cbModelo.getSelectedItem().toString());
    ...
    public void abrirArchivo() {
        ...
        try {
            String ruta = "cortes\\"+lista.get(fila).getExplosivo();
