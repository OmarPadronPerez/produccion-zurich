...
public class TAPIZADO extends javax.swing.JInternalFrame {

    private int x;
    private int y;
    public static ArrayList<ESTILOS> lista = null;
    ...
    public void prepararTabla() {
        ...
        dftm.setColumnIdentifiers(new Object[]{"Nombre", "Forro", "Hilo ", "Tela", "Vinil"});
    }

    public static void llenarTabla() {
        borrarTabla();
        lista = modMuebles.obtenerTapizados();
        for (ESTILOS es : lista) {
            dftm.addRow(new Object[]{es.getNombre(), es.getForro(), es.getHilo(), es.getTela(), es.getVinil()});
        }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(712, 380));
        ...
        jLabel2.setText("ADMINISTRAR TIPOS DE TAPIZADO");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AGREGARTAPIZ ag = new AGREGARTAPIZ(null);
        AUXILIAR.verPantalla(jdpEscritorio, ag);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            int fila = jTable1.getSelectedRow();
            System.out.println(dftm.getValueAt(fila, 0).toString());
            AGREGARTAPIZ ag = new AGREGARTAPIZ(dftm.getValueAt(fila, 0).toString());
            AUXILIAR.verPantalla(jdpEscritorio, ag);
        }
